...
public class ItemVo {
	...
	public String toString() {
		return "ItemVo={\"item_num\":\"" + item_num + "\", \"name\":\"" + name + "\", \"title\":\"" + title
				+ "\", \"count\":\"" + count + "\", \"price\":\"" + price + "\", \"color\":\"" + color
				+ "\", \"main_img\":\"" + main_img + "\", \"detail_img\":\"" + detail_img + "\", \"model_num\":\""
				+ model_num + "\", \"member_id\":\"" + member_id + "\", \"post_time\":\"" + post_time
				+ "\", \"sale_time\":\"" + sale_time + "\", \"sale_end_time\":\"" + sale_end_time + "\", \"state\":\""
				+ state + "\", \"cate_num\":\"" + cate_num + "\"}";
	}
